...
class Rossmann(object):
    ...
    def data_cleaning(self, df1):
        ...
        cols_old = ['Store', 'DayOfWeek', 'Date', 'Open', 'Promo', 'StateHoliday', 'SchoolHoliday', 
                    ...
                    'CompetitionOpenSinceYear', 'Promo2', 'Promo2SinceWeek', 'Promo2SinceYear', 'PromoInterval'] #tirou-se costumers e sales. Como você vai prever o número de clientes? 
        #Isso é motivo pra outro projeto. 
